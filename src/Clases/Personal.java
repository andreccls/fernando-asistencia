...
//                                }
    ...
    public boolean DisponibilidadClase(Date inici, Date finn, List<Iniciofin> inic,List dsem){
        boolean a=true;
//        int d=0;
        Date ot1 = inici;
