...
//        this.idsesion = id;
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Todos", "Apellido", "Nombre" }));
...
//                comboBoxart.setSelectedItem(art);
    ...
    private void jTextField2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField2KeyTyped
        ...
        if ((car >= 'a' && car <= 'z') || (car >= 'A' && car <= 'Z')) {
            ...
            String mes = String.valueOf(jComboBox1.getSelectedItem());
            Drive.CargarTablaInasistencias(jTable1, mes, Integer.parseInt(jTextField1.getText()),buscar,es);
